...
load('realworld_foodwebs_20nodes.RData')
Brose_data <- read.csv('Brose_foodwebdata.csv')

foodweb_name <- realworld_foodwebs_20nodes

rep_webs <- as.data.frame(matrix(nrow=110,ncol=32))
...
save(rep_webs,file = 'whole_reproduce_Empiwebs_20nodes.RData')
